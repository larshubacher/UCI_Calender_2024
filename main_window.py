...
class MainWindow(QMainWindow):
    def __init__(self, app):
        ...
        ## Reiter wird hinzugefügt
        file_menu = menu_bar.addMenu("File")
        ## Quit action is added to "File"
        quit_action = file_menu.addAction("Quit")
        ## Zu ausführender Befehl wird hinzugefügt
        ...
        action2 = QAction(QIcon("images/icon.jpeg"), "Some other action", self)
